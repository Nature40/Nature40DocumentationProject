...
Please Note: The calibration phase was completed on July 12 (2020). The stations will be transferred to the Core Study Trees within the next weekAt this stage, the data have not been checked or validated in any way.
{: .notice--danger}
